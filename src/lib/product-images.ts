...
const LOCAL_ASIN_IMAGES: Record<string, string> = {
  ...
  B09B8V1LZ3: '/images/products/placeholder.svg',
  B00FLYWNYQ: '/images/products/placeholder.svg',
  B0CRMYT2WC: '/images/products/placeholder.svg',
  B085DVNHHK: '/images/products/placeholder.svg',
  B08M8VFJ2Z: '/images/products/placeholder.svg',
  B09HWD3FZN: '/images/products/placeholder.svg',
  B0BNTL3Q2C: '/images/products/placeholder.svg',
  B07GVDXW5D: '/images/products/placeholder.svg',
  B088ZN47V8: '/images/products/placeholder.svg',
  B0BYSKX3BX: '/images/products/placeholder.svg',
};
