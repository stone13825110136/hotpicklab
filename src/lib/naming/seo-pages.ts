...
function buildPage(species: Species, spec: Spec): NamingSeoPage {
  ...
  return {
    ...
    vibe: spec.vibe,
    keyword,
    // Bing flagged short titles — keep ~55–65 chars before brand suffix.
    title: `${heading}: Free Scored List, Compare & Hot Pick`,
    description: `Looking for ${keyword}? Browse a free scored list for ${genderPhrase} ${pets}, filter by ${spec.vibe} vibe, compare 2–5 favorites, and get one Hot Pick — no sign-up.`,
    h1: heading,
